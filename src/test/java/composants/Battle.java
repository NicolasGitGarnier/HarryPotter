...
import composants.Characters.AbstractEnemy;
import composants.Characters.Enemy;
import composants.Characters.WizardTest;
import composants.Potions.Potion;
import composants.Spells.Spell;
...
public class Battle {
    ...
    private WizardTest wizard;
    private Enemy enemy;
    private boolean isFinished = false; //True when the battle is finished.

    // --------------- Battle main code --------------- //
    public Battle(WizardTest wizard, Enemy enemy) { //Used in attack in Wizard.java
        this.wizard = wizard;
        this.enemy = enemy;
    }
    ...
    private void isDead(WizardTest wizard, AbstractEnemy enemy) {
